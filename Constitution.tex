...
\subsubsection{Rights Held Sacred}
...
\subsection{Equal Protection and Due Process}
\subsubsection{Equal Protection}
...
\subsubsection{Monetary Compensation}
...
\subsubsection{Humane Treatment}
...
\subsection{Privacy}
\subsubsection{Personal Security}
...
\paragraph{Religious Freedoms}No person shall be compelled to manifest beliefs against their conscience or be restricted from manifesting their conscience. 
\paragraph{State Religion} No system of thought or religion shall be inhibited or advanced. No religious test shall be applied against public officers.
\subsubsection{Petition and Protest}
